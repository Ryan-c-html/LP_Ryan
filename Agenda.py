...
e_email = Entry(frame_baixo, width=25, justify='center', font=('',10), highlightthickness=1)
e_email.place(x=110, y=35)

l_tel = Label(frame_baixo, text="Telefone:*", anchor=NW, font=("arial 12 bold"),bg=co1, fg=co3)
l_tel.place(x=20, y=56)
e_tel = Label(frame_baixo, width=25, justify='center', font=('',10), highlightthickness=1)
e_tel.place(x=110, y=56)
